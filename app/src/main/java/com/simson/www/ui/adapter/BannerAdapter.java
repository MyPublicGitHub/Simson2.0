...
import com.simson.www.utils.GlideLoaderManager;
...
public class BannerAdapter extends PagerAdapter {
    ...
    private List<BroadcastsBean> mBannerDatas;


    public BannerAdapter(List<BroadcastsBean> mBannerDatas) {
        this.mBannerDatas = mBannerDatas;
        mViews = new SparseArray<>();
    }

    public void notifyDatas(List<BroadcastsBean> mBannerDatas) {
        this.mBannerDatas = mBannerDatas;
    ...
    public Object instantiateItem(final ViewGroup container, int position) {
        ...
        if (view == null) {
            ...
            final BroadcastsBean bean = mBannerDatas.get(position);
            view = LayoutInflater.from(AppContext.getContext()).inflate(R.layout.item_banner, container, false);
            ImageView imageView = (ImageView) view.findViewById(R.id.img);
            TextView titleView = (TextView) view.findViewById(R.id.title);
            GlideLoaderManager.loadImage(bean.getIcon(), imageView);
            titleView.setText(bean.getMenu_title());
...
//                    container.getContext().startActivity(intent);
                    ToastUtils.showToast(bean.getMenu_title()+"");
                }
            });
