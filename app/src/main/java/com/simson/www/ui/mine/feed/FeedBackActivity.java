...
public class FeedBackActivity extends BasePresenterActivity<FeedBackPresenter, FeedBackContract.View>
        implements FeedBackContract.View, BGASortableNinePhotoLayout.Delegate {
    ...
    @Override
    public void feedback(BaseBean bean) {
