...
public class CommonPopupWindow extends PopupWindow {
    ...
    public static class Builder {
        ...
        /**
         * @param layoutResId 设置PopupWindow 布局ID * @return Builder
         */
        ...
        /**
         * @param view 设置PopupWindow布局 * @return Builder
         */
        ...
        /**
         * 设置子View * * @param listener ViewInterface * @return Builder
         */
        ...
        /**
         * 设置宽度和高度 如果不设置 默认是wrap_content * * @param width 宽 * @return Builder
         */
        ...
        /**
         * 设置背景灰色程度 * * @param level 0.0f-1.0f * @return Builder
         */
        ...
        /**
         * 是否可点击Outside消失 * * @param touchable 是否可点击 * @return Builder
         */
